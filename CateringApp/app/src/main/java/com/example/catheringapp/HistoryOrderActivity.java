package com.example.catheringapp;
...
import com.example.catheringapp.adapter.HistoryAdapter;
import com.example.catheringapp.viewmodel.HistoryViewModel;
...
public class HistoryOrderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setToolbar();
        setInitLayout();
        setViewModel(ViewModelProviders);
        setSwipeToDelete(ViewModelProviders);
    }
    ...
    private void setViewModel(Path ViewModelProviders) {
    ...
    private void setSwipeToDelete(Path ViewModelProviders) {
